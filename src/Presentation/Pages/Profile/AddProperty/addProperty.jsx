...
document.body.style.overflow = 'hidden';
    ...
    return(
        <PropertyProvider>
            ...
            <Fab onClick={()=>{setClicked(!clicked)}}    sx={{'&:hover':{
                    backgroundColor:'white',color:'var(--app-blue)'
                },color:'white',backgroundColor:'var(--app-blue)',position:'fixed',bottom:'0',right:'0',borderRadius:'5px' ,marginRight:'40px',marginBottom:'30px',width:'120px',fontFamily:'Lexend' ,height:'40px'}}>{clicked?"Back":"Next"}</Fab>
            <REMap isAdd={true}/>                  
