...
function ServiceSection(){
    return(
        <div className="Main">
            ...
            <Card image="assets/images/buyHouse.svg" name="Browse Properties ." desc="Look through The Wide Selections of Properties Offered in our Website " button="Check out"/>
